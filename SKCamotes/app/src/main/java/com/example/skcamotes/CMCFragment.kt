...
class CMCFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_c_m_c, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the MapView
        mapView = view.findViewById(R.id.cmc_map_view)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val calambaPNPLocation = LatLng(14.206614610136494, 121.1529659175866) // Replace with your coordinates
        // Create a custom marker
        googleMap.addMarker(
            MarkerOptions()
                .position(calambaPNPLocation)
                .title("CMC")
                .snippet("Calamba Medical Center")
