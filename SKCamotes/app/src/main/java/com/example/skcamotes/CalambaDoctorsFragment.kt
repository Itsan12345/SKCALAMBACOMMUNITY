...
class CalambaDoctorsFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_calamba_doctors, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the MapView
        mapView = view.findViewById(R.id.calambadoctors_map_view)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val calambaPNPLocation = LatLng(14.217722190010235, 121.14222358162675) // Replace with your coordinates
        // Create a custom marker
        googleMap.addMarker(
            MarkerOptions()
                .position(calambaPNPLocation)
                .title("Calamba Doctors' Hospital")
                .snippet("“LOVE with A SMILe”")
