...
class MyReservationsThirdFloorFacility : Fragment(), OnMapReadyCallback { // Implement OnMapReadyCallback
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_my_reservations_third_floor_facility, container, false)
