...
class PMCFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_p_m_c, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the MapView
        mapView = view.findViewById(R.id.pmc_map_view)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val calambaPNPLocation = LatLng(14.198479287341385, 121.16150733559863) // Replace with your coordinates
        // Create a custom marker
        googleMap.addMarker(
            MarkerOptions()
                .position(calambaPNPLocation)
                .title("PMC")
                .snippet("Pamana Medical Center")
