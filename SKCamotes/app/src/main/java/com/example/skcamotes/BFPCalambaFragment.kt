...
class BFPCalambaFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_b_f_p_calamba, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the MapView
        mapView = view.findViewById(R.id.bfp_map_view)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val calambaPNPLocation = LatLng(14.19377184600435, 121.15943936102697) // Replace with your coordinates
        // Create a custom marker
        googleMap.addMarker(
            MarkerOptions()
                .position(calambaPNPLocation)
                .title("BFP Calamba")
                .snippet("Bureau of Fire and Protection Calamba")
