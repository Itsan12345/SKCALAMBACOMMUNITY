...
class CancelledReservationsAdapter(private val reservationsList: List<ReservationDataClass>) :
    RecyclerView.Adapter<CancelledReservationsAdapter.ReservationViewHolder>() {
