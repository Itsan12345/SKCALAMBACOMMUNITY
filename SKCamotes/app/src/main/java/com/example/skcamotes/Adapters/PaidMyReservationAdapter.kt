...
class PaidMyReservationAdapter(private val reservationList: List<PaidMyReservationDataClass>) :
    RecyclerView.Adapter<PaidMyReservationAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.myreservation_paid_item, parent, false)
