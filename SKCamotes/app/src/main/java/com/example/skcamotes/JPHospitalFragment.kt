...
class JPHospitalFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_j_p_hospital, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up the MapView
        mapView = view.findViewById(R.id.jphospital_map_view)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val calambaPNPLocation = LatLng(14.191814705846868, 121.16800000621613) // Replace with your coordinates
        // Create a custom marker
        googleMap.addMarker(
            MarkerOptions()
                .position(calambaPNPLocation)
                .title("JPR Hospital")
                .snippet("Dr. Jose P. Rizal Memorial Provincial District Hospital")
