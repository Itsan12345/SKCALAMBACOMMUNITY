...
class AdminReturnedRequestAdapter(private val returnedRequests: List<AdminReturnedRequestDataClass>) :
    RecyclerView.Adapter<AdminReturnedRequestAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.admin_item_returned_request, parent, false)
